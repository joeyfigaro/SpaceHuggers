...
import { ASSERT, EngineObject, ParticleEmitter } from "littlejsengine";
...
///////////////////////////////////////////////////////////////////////////////
// sounds
const sound_shoot =        [,,90,,.01,.03,4,,,,,,,9,50,.2,,.2,.01]; /* prettier-ignore */
const sound_destroyTile =  [.5,,1e3,.02,,.2,1,3,.1,,,,,1,-30,.5,,.5]; /* prettier-ignore */
const sound_die =          [.5,.4,126,.05,,.2,1,2.09,,-4,,,1,1,1,.4,.03]; /* prettier-ignore */
const sound_jump =         [.4,.2,250,.04,,.04,,,1,,,,,3]; /* prettier-ignore */
const sound_dodge =        [.4,.2,150,.05,,.05,,,-1,,,,,4,,,,,.02]; /* prettier-ignore */
const sound_walk =         [.3,.1,70,,,.01,4,,,,-9,.1,,,,,,.5]; /* prettier-ignore */
const sound_explosion =    [2,.2,72,.01,.01,.2,4,,,,,,,1,,.5,.1,.5,.02]; /* prettier-ignore */
const sound_checkpoint =   [.6,0,500,,.04,.3,1,2,,,570,.02,.02,,,,.04]; /* prettier-ignore */
const sound_rain =         [.02,,1e3,2,,2,,,,,,,,99]; /* prettier-ignore */
const sound_wind =         [.01,.3,2e3,2,1,2,,,,,,,1,2,,,,,,.1]; /* prettier-ignore */
const sound_grenade =      [.5,.01,300,,,.02,3,.22,,,-9,.2,,,,,,.5]; /* prettier-ignore */
...
export function explosion(pos, radius = 2) {
  ASSERT(radius > 0);
...
export class TileCascadeDestroy extends EngineObject {
